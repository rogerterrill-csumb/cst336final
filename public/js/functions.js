...
>>>>>>> c48abbd76339aab0007470cde1ad62b5f577d421
...
function getItemCount() {
  $.ajax({
    ...
    success: function(result, status) {
      ...
      //show totals
      $('#totalResults').append(
        "<table><tr><th>Total Products in Store:</th><td id='right'>" +
          result[0].total +
          "</td></tr><tr><th>Active Products:</th><td id='right'>" +
          result[1].total +
          "</td></tr><tr><th>Inactive Products:</th><td id='right'>" +
          result[2].total +
          '</td></tr>'
      );
...
function getPrices() {
  $.ajax({
    ...
    success: function(result, status) {
      ...
      $('#priceResults').append(
        '<tr><th>Category</th><th>Count</th><th>Minimum</th><th>Maximum</th><th>Average</th></tr>'
      );
...
function getOrders() {
  $.ajax({
    ...
    success: function(result, status) {
      ...
      $('#orderResults').append(
        '<tr><th>Order Number</th><th>Invoice Total</th></tr>'
      );
      result.forEach(function(row, i) {
        //show order totals
        $('#orderResults').append(
